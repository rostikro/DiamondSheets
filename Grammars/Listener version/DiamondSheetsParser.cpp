...
void DiamondSheetsParser::NumericAtomExpContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterNumericAtomExp(this);
}
void DiamondSheetsParser::NumericAtomExpContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitNumericAtomExp(this);
}
//----------------- PowerExpContext ------------------------------------------------------------------
...
void DiamondSheetsParser::PowerExpContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterPowerExp(this);
}
void DiamondSheetsParser::PowerExpContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
...
void DiamondSheetsParser::MulDivExpContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterMulDivExp(this);
}
void DiamondSheetsParser::MulDivExpContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
...
void DiamondSheetsParser::ParenthesisExpContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterParenthesisExp(this);
}
void DiamondSheetsParser::ParenthesisExpContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
...
void DiamondSheetsParser::IdAtomExpContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterIdAtomExp(this);
}
void DiamondSheetsParser::IdAtomExpContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitIdAtomExp(this);
}
//----------------- AddSubExpContext ------------------------------------------------------------------
...
void DiamondSheetsParser::AddSubExpContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterAddSubExp(this);
}
void DiamondSheetsParser::AddSubExpContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
...
void DiamondSheetsParser::FunctionExpContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterFunctionExp(this);
}
void DiamondSheetsParser::FunctionExpContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<DiamondSheetsListener *>(listener);
  if (parserListener != nullptr)
